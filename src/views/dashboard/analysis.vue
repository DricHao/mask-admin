<template>
  <div style="padding:10px">
    <a-spin :spinning="loading">
     <!-- apex -->
    <a-row :gutter="48" style="margin-bottom:24px;">
      <a-col :xs="24" :sm="12" :md="12" :lg="12">
          <chart-min-chart   color="#fd397a" :countValue="count[0]" desc="今日检测人数" type="line" :data="list" separator="" :opacity="0.9"/>
      </a-col>
      <a-col :xs="24" :sm="12" :md="12" :lg="12">
          <chart-min-chart color="#fd7e14" :countValue="count[1]" desc="今日未通过人数" :data="list" separator=""/>
      </a-col>
